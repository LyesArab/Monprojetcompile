...
%%
  ...
  ;
  declarationidf: |declarationidf type mc_idf Vg pvg   
...
Declarations:
 ...
 operationarr:
        mc_idf mc_op mc_idf|
        mc_idf mc_op mc_int|
        mc_idf mc_op mc_float|
        mc_int mc_op mc_int |
        arc mc_idf mc_op mc_idf farc mc_op mc_idf
...
;
affectation :
         mc_idf aff mc_int pvg|
         mc_idf aff mc_idf pvg| 
         mc_idf aff operationarr pvg 
;
compteur:
 mc_idf incr|
 mc_idf decr 
...
list_inst:|affectation list_inst
          ...
          |mc_for arc mc_idf aff mc_int vg condition vg compteur farc debut list_inst fin list_inst
